...
async function applyServerStorage(param, options) {
    ...
    const currentByName = new Map((allCookies === null || allCookies === void 0 ? void 0 : allCookies.map((param)=>{
        let { name, value } = param;
        return [
            name,
            value
    ...
    const setCookiesToWrite = setCookies.filter((param)=>{
        let { name, value } = param;
        return currentByName.get(name) !== value;
    });
...
//# sourceMappingURL=node_modules_d3bf23ae._.js.map