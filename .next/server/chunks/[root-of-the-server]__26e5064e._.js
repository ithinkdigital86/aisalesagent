module.exports = [
"[project]/.next-internal/server/app/api/agents/sales-manager/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/agents/sales-manager/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { data: actions } = await db.from('actions').select('channel, status, replied_at').eq('workspace_id', workspaceId);
        const channelStats = {};
        ...
        if (!run.ok || !run.data) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: run.error ?? 'Sales Manager run failed'
            }, {
                status: 502
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__26e5064e._.js.map